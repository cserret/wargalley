    ...
    const setupStoryboard = () => {
        ...
        let page27 = {
            ...
            fn: () => {
                ...
                setTimeout(() => {
                    emergencySupplyMarker.animate({ width: 64, height: 64, transform: 't 540, 176' }, 500, mina.easeout);
                }, 18500);
                ...
                textBox(g, 
                    ...
                    posX, posY, 30000, 40000)

                    setTimeout(() => {
                        outOfSupplyMarker.animate({ transform: 't 538, -1141', opacity: 0 }, 300);
                    }, 40500);
